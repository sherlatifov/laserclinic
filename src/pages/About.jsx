    ...
    <div>
      ...
      <div className="">
        <div className="container">
          ...
          <div className={`${styles.positioningCardLayout} d-block d-md-flex flex-md-row flex-column justify-content-between`}>
            <div className={`${styles.positioningCard} h-100 w-100 d-flex justify-content-md-center justify-content-start align-items-center`}>
        ...
        <div className="container">
          ...
          <div className='row g-3'>
            <div className="col-12 col-lg-6">
              <div className={`${styles.whyWeCard} card h-100`}>
